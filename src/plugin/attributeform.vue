    ...
    <el-tabs :class="formclass" v-model="activeName" type="card">
      <el-tab-pane label="字段设置" name="1">
        <el-form :model="form" label-width="80px" size='small'>
          ...
          <!-- 图片 -->
          <!-- 这里的图片引入改为可多选 可单选 -->
          <!-- <el-form-item label="是否多选" v-if='form.showFrom.indexOf("src") !== -1'>
            <el-switch v-model="form.showFrom.isMultiple" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
          </el-form-item>
          <span v-if='form.showFrom.indexOf("src") !== -1'>
            <el-form-item label="图片地址" v-for="(item, index) in form.src" :key="index"> 
              <el-input placeholder="请输入图片地址" prefix-icon="el-icon-link" v-model="form.src[index]" /><el-button v-if="index !== 0">删除</el-button>
            </el-form-item>
          </span> 
          <el-button v-if="form.showFrom.isMultiple" @click="addPic">添加图片地址</el-button> -->
          <el-form-item label="是否多图" v-if='form.showFrom.indexOf("isMultiple") !== -1'>
            <el-switch v-model="form.isMultiple" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
          </el-form-item>
          ...
          <el-form-item v-if='form.isMultiple' label="最大图数">
            <el-input-number :min="1" :max="1000" v-model="form.maxSrc"></el-input-number>
          </el-form-item>
      ...
      <el-tab-pane label="校验设置" name="2">
        <el-form v-if='form.rules.length > 0' :model="form" label-width="80px" size='small'>
          ...
          <el-button style="margin-top:5px" v-if='form.type === "Input"' @click="dialogVisible=true" size="small">添加正则校验</el-button>
