<template>
  <el-card class="elcard">
    <div slot="header" class="clearfix">
      <span><i class="el-icon-edit-outline" />表单设计</span>
      <el-button style="float: right; padding: 3px 0;margin-left:5px" type="text" icon="fa fa-floppy-o" @click="save">保存</el-button>
      <el-button style="float: right; padding: 3px 0;margin-left:5px" type="text" icon="el-icon-view" @click="yulan">预览</el-button>
      <el-button style="float: right; padding: 3px 0;margin-left:5px" type="text" icon="fa fa-cloud-download" @click="()=>this.$emit('downloadvue')">下载源码</el-button>
   </div>
    <div
      class="elcardzz"
      @dragover="dragover"
